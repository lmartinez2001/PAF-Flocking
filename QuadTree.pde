...
class Quadtree implements IDrawable {
    ...
    Boid[] query(Circle range, ArrayList<Boid> found) {
        ...
        if(!boundary.intersects(range)) {
            return found.toArray(new Boid[0]); // Liste vide
        }
        ...
        return found.toArray(new Boid[0]);
    }
    /*
    ArrayList<Boid> query(Circle range, ArrayList<Boid> found) {
        ...
        boidsArray = found.toArray(new Boid[0]);
        return found;
    }*/
